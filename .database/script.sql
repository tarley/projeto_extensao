...
START TRANSACTION;
USE `extensao`;
INSERT INTO `extensao`.`usuario` (`id`, `nome`, `email`, `senha`, `idc_tipo_usuario`) VALUES (1, 'Leonardo Silva', 'extensao@email.com', SHA1('123'), 3);
INSERT INTO `extensao`.`usuario` (`id`, `nome`, `email`, `senha`, `idc_tipo_usuario`) VALUES (2, 'Monica', 'coordenador@email.com', SHA1('123'), 2);
INSERT INTO `extensao`.`usuario` (`id`, `nome`, `email`, `senha`, `idc_tipo_usuario`) VALUES (3, 'Tarley Lana', 'professor@email.com', SHA1('123'), 1);
