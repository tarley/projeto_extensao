...
START TRANSACTION;
USE `extensao`;
INSERT INTO `extensao`.`usuario` (`id`, `nome`, `email`, `senha`, `idc_tipo_usuario`) VALUES (DEFAULT, 'Leonardo Silva', 'extensao@email.com', '123', 3);
INSERT INTO `extensao`.`usuario` (`id`, `nome`, `email`, `senha`, `idc_tipo_usuario`) VALUES (DEFAULT, 'Monica', 'coordenador@email.com', '123', 2);
INSERT INTO `extensao`.`usuario` (`id`, `nome`, `email`, `senha`, `idc_tipo_usuario`) VALUES (DEFAULT, 'Tarley', 'professor@email.com', '123', 1);
